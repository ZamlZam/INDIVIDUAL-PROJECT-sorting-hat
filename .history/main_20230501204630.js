...
const start= ()=>{
   domString += `<div class="card" style="width: 18rem;" >
      <img src=${houses.imageUrl} class="card-img-top" alt=${houses.name}>
       ...
       <button class="submit<button class="btn btn-danger" id="expel--${houses.id}">expel</button><button class="btn btn-danger" id="expel--${<button class="btn btn-danger" id="expel--${houses.id}">expel</button>
